...
print("    -d '{")
print('      "workclass": "Private", "education": "Bachelors",')
print('      "marital-status": "Married-civ-spouse", "occupation": "Exec-managerial",')
print('      "relationship": "Husband", "race": "White", "sex": "Male",')
print('      "native-country": "United-States",')
print('      "age": 45, "fnlwgt": 200000, "education-num": 13,')
print('      "capital-gain": 0, "capital-loss": 0, "hours-per-week": 40')
print("    }'")
