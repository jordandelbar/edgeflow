...
<span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium {stateStyle[state] ?? 'bg-gray-100 text-gray-600'}">
  <i class="{stateIcon[state] ?? 'fa-solid fa-circle'} text-xs"></i>
  {state}
</span>
